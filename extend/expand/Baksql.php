...
class Baksql {
    ...
    public function __construct($config) {
        $config['path'] = ROOT_PATH."public".DS."backsql".DS; //默认目录 
    ...
    private function writeToFile($tables = array(), $ddl = array(), $data = array())
    {
        ...
        return file_put_contents($this->config['path'].$this->config['sqlbakname'], $str) ? '备份成功!花费时间' . round(microtime(true) - $this->begin,2) . 'ms':exception("备份失败！",901);
    }
    /**
     * 设置要备份的表
     * @param array $tables
