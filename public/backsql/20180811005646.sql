...
-- Records of of_admin
-- ----------------------------
INSERT INTO `of_admin` (`id`,`admin_name`,`password`,`img`,`role_id`,`account`,`sex`,`state`,`add_time`,`last_time`) VALUES ('1','游兴祥','83da85fd821d97b07e11440269315151','/uploads/image/20180811/6c9d228310c44b5be070737af6263d25.jpg','1','1365831278@qq.com','1','1','1505874617','1533917979');
INSERT INTO `of_admin` (`id`,`admin_name`,`password`,`img`,`role_id`,`account`,`sex`,`state`,`add_time`,`last_time`) VALUES ('4','测试','83da85fd821d97b07e11440269315151','/uploads/image/20180811/c52fb7986c57e22c2f7b71790d38d1a2.jpg','2','123456','1','1','1532794210','1533920047');
...
INSERT INTO `of_config_field` (`id`,`k`,`v`,`type`,`desc`,`prompt`,`sorts`,`status`,`texttype`,`textvalue`,`create_time`,`update_time`) VALUES ('18','print_position','9','up','水印图片位置','水印图片位置','9','1','select','','1495996448','1533913267');
...
) ENGINE=MyISAM AUTO_INCREMENT=693 DEFAULT CHARSET=utf8 COMMENT=' 操作日志表';
-- ----------------------------
-- Records of of_log
-- ----------------------------
...
INSERT INTO `of_nav` (`id`,`name`,`parent_id`,`url`,`show_position`,`order_key`,`create_time`,`update_time`) VALUES ('2','城市','0','/shanghai','1','1','1532942592','1533913648');
...
-- ----------------------------
INSERT INTO `of_product` (`id`,`name`,`img`,`flag`,`rent`,`city_id`,`region_id`,`address`,`subway`,`airport`,`lg`,`lat`,`summary`,`area`,`equipment`,`seo_title`,`seo_des`,`order_key`,`state`,`create_time`,`update_time`,`tag`,`bs_id`) VALUES ('1','静安嘉里中心商务中心001','/uploads/image/20180806/bafa50f2d1cd3f0c8fd71bd101828c16.jpg','1','8888','2','4','华夏路','2/7号线静安寺站，步行2分钟','距离机场30分','121.456091','31.230261','<p>
	静安嘉里中心商务中心于2013年初开业，位于新建成的高档写字楼内，商业设施完善，拥有高档舒适的工作环境有国际水准的服务团队提供体贴、周到和有效的商务服务。静安嘉里中心为高标准的甲级写字楼.
</p>
<p>
	<br />
</p>
<p>
	2013年建成交付位于南京西路CBD，紧邻静安寺静安公园、越洋广场等，地段一流，商务条件得天独厚。该大厦与地铁7号线静安寺站相连，出行快捷方便。
</p>','<ul class=\"ul-item01 list-paddingleft-2\" style=\"box-sizing:border-box;margin:0px;padding:0px 0px 0px 30px;border:0px;font-size:14px;vertical-align:baseline;list-style:none;width:782.797px;color:#333333;font-family:sans-serif;white-space:normal;\">
	...
	<li style=\"box-sizing:border-box;margin:0px;padding:0px;border:0px;vertical-align:baseline;clear:both;\">
		<div class=\"tit\" style=\"box-sizing:border-box;margin:0px;padding:0px;border:0px;vertical-align:baseline;\">
			<p>
				在商业最繁华的地段提供全配备的办公室不限时的出入带有安全可靠的门禁系统办公室；提供24小时照明、供电和供水设
			</p>
		</div>
	</li>
	<li style=\"box-sizing:border-box;margin:0px;padding:0px;border:0px;vertical-align:baseline;clear:both;\">
	...
	<li style=\"box-sizing:border-box;margin:0px;padding:0px;border:0px;vertical-align:baseline;clear:both;\">
		<div class=\"tit\" style=\"box-sizing:border-box;margin:0px;padding:0px;border:0px;vertical-align:baseline;\">
			<p>
				便捷高效的通讯设施,使用您的公司名字接听所有来电；无限量的电话接听和呼叫转移功能；互联网的专线宽带接入；提供中心传真设备的使
			</p>
		</div>
	</li>
	<li style=\"box-sizing:border-box;margin:0px;padding:0px;border:0px;vertical-align:baseline;clear:both;\">
	...
	<li style=\"box-sizing:border-box;margin:0px;padding:0px;border:0px;vertical-align:baseline;clear:both;\">
		<div class=\"tit\" style=\"box-sizing:border-box;margin:0px;padding:0px;border:0px;vertical-align:baseline;\">
			其他免费设施享受免费的现磨咖啡、茶和饮用水；享受各地同品牌商务中心会议室的免费使用；享受免费赠阅的报刊和杂志。
		</div>
		<div class=\"txt\" style=\"box-sizing:border-box;margin:0px;padding:0px;border:0px;vertical-align:baseline;\">
			<br />
		</div>
	</li>
</ul>','静安嘉里中心商务中心','静安嘉里中心商务中心','1','1','1533363241','1533917864','高档办公,cbd商圈,专业服务,非常不错','7');
INSERT INTO `of_product` (`id`,`name`,`img`,`flag`,`rent`,`city_id`,`region_id`,`address`,`subway`,`airport`,`lg`,`lat`,`summary`,`area`,`equipment`,`seo_title`,`seo_des`,`order_key`,`state`,`create_time`,`update_time`,`tag`,`bs_id`) VALUES ('2','静安嘉里中心商务中心','/uploads/image/20180806/e692e418bd43f4fae221991fdc3e8fcf.jpg','1','777','2','3','华夏路','2/7号线静安寺站，步行2分钟','距离机场30分','121.460418','31.23','静安嘉里中心商务中心于2013年初开业，位于新建成的高档写字楼内，商业设施完善，拥有高档舒适的工作环境有国际水准的服务团队提供体贴、周到和有效的商务服务。静安嘉里中心为高标准的甲级写字楼，2013年建成交付位于南京西路CBD，紧邻静安寺静安公园、越洋广场等，地段一流，商务条件得天独厚。该大厦与地铁7号线静安寺站相连，出行快捷方便。','<ul class=\"ul-item01 list-paddingleft-2\" style=\"box-sizing:border-box;margin:0px;padding:0px 0px 0px 30px;border:0px;font-size:14px;vertical-align:baseline;list-style:none;width:782.797px;color:#333333;font-family:sans-serif;white-space:normal;\">
	...
	<li style=\"box-sizing:border-box;margin:0px;padding:0px;border:0px;vertical-align:baseline;clear:both;\">
		...
		<div class=\"txt\" style=\"box-sizing:border-box;margin:0px;padding:0px;border:0px;vertical-align:baseline;\">
			在商业最繁华的地段提供全配备的办公室不限时的出入带有安全可靠的门禁系统办公室；提供24小时照明、供电和供水设备的使用；办公室日常保洁和维护
		</div>
	</li>
	<li style=\"box-sizing:border-box;margin:0px;padding:0px;border:0px;vertical-align:baseline;clear:both;\">
		<div class=\"txt\" style=\"box-sizing:border-box;margin:0px;padding:0px;border:0px;vertical-align:baseline;\">
			使用您的公司名字接听所有来电；无限量的电话接听和呼叫转移功能；互联网的专线宽带接入；提供中心传真设备
		</div>
	</li>
	<li style=\"box-sizing:border-box;margin:0px;padding:0px;border:0px;vertical-align:baseline;clear:both;\">
		<div class=\"txt\" style=\"box-sizing:border-box;margin:0px;padding:0px;border:0px;vertical-align:baseline;\">
...
INSERT INTO `of_role` (`id`,`role_name`,`role_type`,`describe`,`role_pri`,`add_time`) VALUES ('2','普通管理员','2','管理网站','16,17,18,19,20,21,75,76,77,22,23,24,25,30,35,36,44,45,46,37,47,48,49,38,50,51,52,39,41,42,43,70,71,72,73,56,57,58,59,60,74,61,62,63,64,65,66,67,68,69,1,2,3,4,5,10,11,12,13,14,15','1528633466');
...
INSERT INTO `of_url_simplify` (`id`,`url_title`,`table_name`,`other_id`,`create_time`) VALUES ('3','jiali','Product','1','1533363241');
